...
BOOT:
    ...
    mov ax, 0x00 ; acá empieza el stack
    mov ds, ax
    mov ss, ax
...
PMODE_MAIN:
    ...
    or al, 2
    out 0x92, al
    mov esi, MSG ;esi es para cadenas
    mov edx, 0xB8000 ; lo pongo acá unu para que ya quede cargado
...
OSOUT:
    ...
    lodsb
    cmp al, 0
    je FINISH ; si es un 0 (terminó el MSG)
    mov ah, 0x0E

    int 0x10 ; llamada de BIOS para imprimir caracter
    jmp OSOUT
